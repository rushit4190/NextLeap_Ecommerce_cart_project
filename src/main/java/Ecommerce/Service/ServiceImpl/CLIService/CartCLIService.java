...
@Service
public class CartCLIService implements CartService {
    ...
    public CartCLIService(CartDBInterface cartDBInterf, ProductDBInterface prodDBinterf, CartItemDBInterface cartItemDBInterf){
    ...
    @Override
    public List<CartItem> getCartItems(String sessionId) throws SessionExpiredException, CartItemNotAvail {
        String userId = getUserIdFromSessionId(sessionId);
        ...
        List<CartItem> cartItems = cartItemDBInterface.getCartItems(cartToRead.getCartId());
        readCartItems(cartItems, cartToRead);
        System.out.println("Cart items read successfully");
        return cartItems;
    }
